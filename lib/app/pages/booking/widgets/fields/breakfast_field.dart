...
class BreakfastField extends StatelessWidget {
  const BreakfastField({super.key});
              ...
              Row(
                children: [
                  GestureDetector(
                    ...
                    onTap: () => context.read<BookingRepo>().breakfast = true,
                    child: SizedBox(
                      height: 24.h,
                      width: 148.w,
                      child: Row(
                        ...
                        children: [
                          SvgPicture.asset(
                            context.watch<BookingRepo>().breakfast == null
                                ? 'assets/icons/Property 1=off-1.svg'
                                : context.read<BookingRepo>().breakfast == true
                  ...
                  GestureDetector(
                    behavior: HitTestBehavior.opaque,
                    onTap: () => context.read<BookingRepo>().breakfast = false,
                    child: SizedBox(
                      height: 24.h,
                      width: 148.w,
                      child: Row(
                        ...
                        children: [
                          SvgPicture.asset(
                            context.read<BookingRepo>().breakfast == null
                                ? 'assets/icons/Property 1=off-1.svg'
                                : context.read<BookingRepo>().breakfast == false
                                    ? 'assets/icons/Property 1=on-1.svg'
                                    : 'assets/icons/Property 1=off-1.svg',
                            width: 24.h,
                            height: 24.h,
