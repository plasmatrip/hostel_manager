...
class _PhoneFieldState extends State<PhoneField> {
  ...
  @override
  void initState() {
    controller = TextEditingController(text: context.read<BookingRepo>().phone);
    super.initState();
  }
      ...
      children: [
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Телефон', style: context.s14w400.copyWith(color: greyGrey)),
              SizedBox(height: 6.h),
              Padding(
                ...
                child: TextField(
                  ...
                  minLines: 1,
                  maxLines: 6,
                  onChanged: (value) => context.read<BookingRepo>().phone = value,
