...
class _DescriptionFieldState extends State<DescriptionField> {
  ...
  @override
  void initState() {
    controller = TextEditingController(text: context.read<RoomRepo>().description);
    super.initState();
  }
      ...
      children: [
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Описание', style: context.s14w400.copyWith(color: greyGrey)),
              SizedBox(height: 6.h),
              Padding(
                ...
                child: TextField(
                  ...
                  minLines: 1,
                  maxLines: 6,
                  onChanged: (value) => context.read<RoomRepo>().description = value,
